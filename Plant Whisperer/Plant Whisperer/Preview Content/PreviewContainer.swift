...
let previewContainer: ModelContainer = {
    ...
    let gardeningNotes = [
        Note(title: "Planting Schedule",
             body: "Tomatoes: Spring, Carrots: Early Summer, Spinach: Fall."),
        Note(title: "Soil Preparation",
             body: "Add compost and test pH levels before planting."),
        Note(title: "Watering Tips",
             body: "Water early in the morning to prevent evaporation."),
        Note(title: "Pest Control",
             body: "Use neem oil or companion planting to deter aphids and beetles."),
        Note(title: "Harvesting Guide",
             body: "Pick tomatoes when fully red; carrots when tops are about 1 inch wide.")
    ]
    // add vegetables
